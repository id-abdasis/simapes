            ...
            <div class="block-content">
                <form action="{{ route('pertokoan.store-kategori') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_kategori" value="{{ old('kode_kategori') }}">
                    </div>
                    <div class="form-group">
                        <label for="nama_kategori">Nama Kategori </label>
                        <input value="{{ old('nama_kategori') }}" type="text" class="form-control isMaxLength" id="nis_nasabah" name="nama_kategori" placeholder="Masukan Nama Kategori" maxlength="100">
                    </div>

                    <div class="form-group">
                        <label for="diskripsi_kategori">Diskripsi Kategori </label>
                        <textarea name="diskripsi_kategori" id="" cols="30" rows="10" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-alt-primary mr-5 mb-5 btn-block"> <i class="fa fa-user-plus mr-5"></i> Tambah Kategori</button>
                    </div>
                </form>
            </div>
        </div>
