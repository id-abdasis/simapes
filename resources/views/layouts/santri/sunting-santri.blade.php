...
<div class="row animated zoomIn">
    <div class="col-md-8 col-sm-12 ">
        <div class="js-wizard-validation-classic block" id=" ">
            ...
            <form class="js-wizard-validation-classic-form" action="{{ route('update-santri') }}" method="post"
                novalidate="validate">
                @csrf
                    ...
                    <div class="tab-pane active" id="data-santri" role="tabpanel">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input value="{{ $santri->nama_lengkap }}" maxlength="100" required type="text"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input value="{{ $santri->nama_panggilan }}" type="text"
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required maxlength="100" value="{{ $santri->tempat_lahir }}"
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input value="{{ $santri->tanggal_lahir }}" required type="text"
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <textarea required maxlength="200" class="form-control isMaxLength" id="alamat-santri"
                                    ...
                                    placeholder="Masukan Alamat Sesuai Di KTP">{{ $santri->alamat_lengkap }}</textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ $santri->no_telepon }}" class="telepon isMaxLength form-control" type="text"
