                ...
                <div class="content-header-section align-parent">
                    ...
                    <div class="content-header-item">
                        ...
                        <a class="align-middle link-effect text-primary-dark font-w600"
                            href="be_pages_generic_profile.php">John Smith</a>
                    </div>
                </div>
            </div>
                ...
                <div class="block pull-r-l">
                    <div class="block-header bg-body-light">
                        <h3 class="block-title">
                            <i class="fa fa-fw fa-users font-size-default mr-5"></i>Friends
                        </h3>
                        ...
                        <ul class="nav-users push">
                            <li>
                                <a href="be_pages_generic_profile.php">
                                    <img class="img-avatar" src="{{ url('/') }}/assets/media/avatars/avatar7.jpg" alt="" />
                            ...
                            <li>
                                <a href="be_pages_generic_profile.php">
                                    <img class="img-avatar" src="{{ url('/') }}/assets/media/avatars/avatar2.jpg" alt="" />
                            ...
                            <li>
                                <a href="be_pages_generic_profile.php">
                                    <img class="img-avatar" src="{{ url('/') }}/assets/media/avatars/avatar10.jpg" alt="" />
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-checkbox mb-5">
                                    <input type="checkbox" class="custom-control-input"
                                        id="side-overlay-settings-status" name="side-overlay-settings-status" value="1"
                                        checked />
                                ...
                                <div class="custom-control custom-checkbox mb-5">
                                    ...
                                    <label class="custom-control-label"
                                        for="side-overlay-settings-public-profile">Public Profile</label>
                                </div>
                                <div class="custom-control custom-checkbox mb-5">
                                    <input type="checkbox" class="custom-control-input"
                                    ...
                                    <label class="custom-control-label"
                                        for="side-overlay-settings-notifications">Notifications</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="custom-control custom-checkbox mb-5">
