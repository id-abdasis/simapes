...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Login Administrator E-Nura</title>
                        ...
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                <p class="font-size-h3 font-w600 text-white">
                                    Sistem Management Pesantren Nurul Amanah.
                                </p>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="index.html">
                                        ...
                                        <span class="font-size-xl text-primary-dark">Simapes</span><span class="font-size-xl"> Nura</span>
                                    </a>
                                ...
                                <form class="js-validation-signin px-30" action="{{ route('login') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-sm btn-hero btn-block btn-alt-primary">
